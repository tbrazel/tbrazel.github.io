...
## Software
- [`MackeyFunctors.jl`](/MackeyFunctors.jl), an upcoming Julia package for working with Mackey functors for arbitrary finite  groups. With S. Atherton, M. Franz, D. Isaksen, B. Spitz, C. Vogeli, L. Zhou
